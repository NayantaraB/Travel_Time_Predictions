...
## Documentation:
All codes and description is provided in the that can be downloaded from [travel_time_kolkata.ipynb](https://github.com/NayantaraB/Travel_Time_Predictions/blob/main/kolkata_wards.json) in this repository and used directly in your preferred coding environmnet. 
